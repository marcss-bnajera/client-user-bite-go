...
import { Menu, X, Search, ShoppingBag, CalendarDays, Bell, LogOut } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import { searchProducts, getUnreadCount } from "../../shared/api";
        ...
        <nav className="bg-[#F5EFE6] shadow-sm border-b border-[#E8D8C3] sticky top-0 z-50">
            <div className="relative h-16 flex items-center px-4">
                ...
                <div className="absolute right-4 flex items-center gap-2 sm:gap-3">
                    ...
                    {isAuthenticated && (
                        <Link to="/notifications" className="relative p-2 rounded-xl hover:bg-[#E8D8C3] text-[#6B6B6B] transition-colors">
                            <Bell size={20} />
                            {unreadCount > 0 && (
                                <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] bg-[#C0392B] text-white text-[10px] font-bold rounded-full flex items-center justify-center px-1">
